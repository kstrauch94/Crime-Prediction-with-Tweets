...
from utils.consts import LDA_PARAMS, LDA_TOPICS, PROCESSED_TWEETS_DATA_PATH
from utils.geo import generate_tweets_docs
...
def main():
    ...
    print('#effective topics (i.e. withoug unifrom distribution on words): ', lda_params['n_components']-n_trivial_topics)
