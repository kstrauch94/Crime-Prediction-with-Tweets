...
df["Topics"] = ["Number of tweets in Corpus","Average micro test precision percentage","Average macro test precision percentage","Average micro test recall percentage","Average macro test recall percentage"]
